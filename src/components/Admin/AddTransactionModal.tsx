...
import { fetchStudent, updateStudent } from "@/utils/queries"
...
const AddTransactionModal: FC<AppProps> = () => {
// ** STATE DECLARATIONS
  ...
  const updateStudentData = (data: any): Student => {
    ...
    if (transactionType === 'deposit' || 'receive') {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await updateStudent(JSON.stringify(updatedStudent));
